    ...
    return (
        <>
            ...
            <div className="flex flex-col mt-8 p-2">
                        ...
                        <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                          ...
                          <ul role="list" className="mt-8 space-y-8 text-gray-600">
                            <li className="flex gap-x-3">
                              ...
                              <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" height={30} width={30}>
                            ...
                            <li className="flex gap-x-3">
                              <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" height={30} width={30}>
                ...
                <div className="">
                  <h1 className="text-center mt-11 text-3xl font-bold">{sectionData[0]? '':<p> Coming Soon!</p>}</h1>
                </div>
