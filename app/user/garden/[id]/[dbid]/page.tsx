                ...
                <div className="mt-1 flex flex-col p-2">
                    <div className="rounded-xl border">
                        <div className="py-4 text-center">
                            ...
                            <p className=" mt-6 text-lg italic leading-8 text-gray-800">
                            ...
                            <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                                <div className="lg:pr-4">
                                    <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                                        <ul
                                            role="list"
                                            className="mt-2 space-y-5 text-gray-600"
                                        >
                    ...
                    <div className="mt-4 rounded-xl border">
                        <div className="py-4 text-center">
                            ...
                            <p className="mt-2 text-base leading-8 text-gray-800">
                                Tips on caring for your new plant.
                            </p>
                        </div>
                    </div>

                    <div className="">
                        <h1 className="py-5 text-center text-xl font-semibold">
                            {sectionData[0] ? "" : <p> Coming Soon!</p>}
                        </h1>
                    </div>
                    ...
                    <div className="relative isolate overflow-hidden bg-white px-6 py-4 lg:overflow-visible lg:px-0">
                        {sectionData.map((item) => (
                            <div
                                className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start"
                                key={item.id}
                            >
                    ...
                    <div className="mt-4 rounded-xl border">
                        <div className="py-4 text-center">
                            ...
                            <p className="mt-2 text-base leading-8 text-gray-800">
                                Discover what diseases your plant may have.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="py-4 text-center lg:max-w-lg">
                        <span className="mt-1 text-xl font-normal tracking-tight text-gray-900 sm:text-4xl">
                            Your plant is:{" "}
                        </span>
                        <span className="mt-1 text-xl font-semibold tracking-tight text-primary-400">
                            {health?.is_healthy ? (
                                <span>
                                    {(
                                        health?.is_healthy_probability * 100
                                    ).toFixed(2)}
                                    % Healthy
                                </span>
                            ) : (
                    ...
                    <ul role="list" className="space-y-3 px-6 text-gray-600">
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div className="flex">
                                        ...
                                        <span
                                            className="px-2"
                                            onClick={() =>
                                                toggleExpand(item.entity_id)
                                            }
                                        >
                                            <strong className="font-bold tracking-tight text-gray-900">
                                                {item.name}
                                            </strong>
                                        </span>
                                    </div>
                                ...
                                {expanded === item.entity_id && (
                                    <div className="transition duration-200">
                                        <div className="p-2">
                                            <span className="">
                                                <strong className="font-normal tracking-tight text-gray-900">
                                                    {
